...
const InputCreator = ({ onUpdate }) => {
    ...
    const addExperience = () => {
        ...
        setValue('experience', [...currentExperience, { title: '', company: '', startDate: '', endDate: '', description: '' }]);
    };
            ...
            {getValues('experience').map((exp, index) => (
                <div key={index} className="mt-2">
                    ...
                    <input
                        ...
                        placeholder="Company"
                        className="w-full p-3 mt-2 border border-gray-300 mb-2 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                    Start Date
                    <input
                        type='date'
                        ...
                        className="w-full p-3 mt-2  mb-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                    End Date
                    <input
                        type='date'
